...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPageTitles = getResources().getStringArray(R.array.planets_array);
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		if (drawerOpen)
			hideOptionMenuActionBar(menu);

		return super.onPrepareOptionsMenu(menu);
	}

	private void hideOptionMenuActionBar(Menu menu) {
		Log.d("hideOptionMenuActionBar", "Position :" + itemSelectedPosition);
		switch (itemSelectedPosition) {
		case 0:
			menu.findItem(R.id.action_sendAudio).setVisible(false);
			menu.findItem(R.id.action_sendVideo).setVisible(false);
			menu.findItem(R.id.action_sendText).setVisible(false);
			break;
		case 1:
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_sendText:
			new ComposeFragment().actionSendText(MainActivity.this);
			return true;
		case R.id.action_sendAudio:
		...
		case R.id.action_addContact:
			...
			new ContactsFragment().addContactDialog(this);
	...
	private void selectItem(int position) {
		...
		switch (position) {
		case 0:
			Fragment fragment1 = new ComposeFragment();
	...
	public void openComposeWithContact(String username){
		Fragment fragment1 = new ComposeFragment();
